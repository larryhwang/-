...
-(NSMutableArray*)OptBtnsArr {
    if (_OptBtnsArr ==nil) {
        _OptBtnsArr = [NSMutableArray new];
    }
    return _OptBtnsArr;
}
...
-(void)setTagWithTagArray:(NSArray*)arr{
    ...
    [arr enumerateObjectsUsingBlock:^(NSString*str, NSUInteger idx, BOOL *stop) {
        ...
        if(_signalTagColor){
         ...
         //   tagBtn.backgroundColor=OptionsLabelDeafualtBackgroudColor;
        }else{
            //tag颜色多样
        ...
        tagBtn.titleLabel.font=[UIFont boldSystemFontOfSize:18];
        ...
        [self.OptBtnsArr addObject:tagBtn];
...
-(void)tagBtnClick:(UIButton*)button{
    ...
    if(button.selected==YES){
        ...
        //点击后的背景颜色
        button.backgroundColor=OptionsLabelDeafualtBackgroudColor;
